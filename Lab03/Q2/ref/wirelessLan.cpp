...
const double maxRTM = 3;
const int maxPktSize = 1544;
const int ackPktSize = 64;
const double channelCapacity = 11000000.0;
const double SIFS = 0.00005;
const double DIFS = 0.0001;
const double SYNC = 0.00001;
...
int generateRandomBackOff(int T, const int backoff[], int N)
{
    ...
    std::uniform_int_distribution<int> idist(1, T);
